...
const Home = lazy(() => import(/* webpackChunkName: "home", webpackPrefetch: true */ "../app/(site)/(site)/_components/Home"));
const Pricing = lazy(() => import(/* webpackChunkName: "pricing", webpackPrefetch: true */ "../app/(site)/(site)/_components/Pricing"));
const Docs = lazy(() => import(/* webpackChunkName: "docs", webpackPrefetch: true */ "../app/(site)/(site)/_components/Docs"));
const ApiReference = lazy(() =>
  import(/* webpackChunkName: "api-reference", webpackPrefetch: true */ "../app/(site)/(site)/_components/ApiReference")
);
const Blog = lazy(() => import(/* webpackChunkName: "blog", webpackPrefetch: true */ "../app/(site)/(site)/_components/Blog"));
const CaseStudies = lazy(() =>
  import(/* webpackChunkName: "case-studies", webpackPrefetch: true */ "../app/(site)/(site)/_components/CaseStudies")
);
const Changelog = lazy(() => import(/* webpackChunkName: "changelog" */ "../app/(site)/(site)/_components/Changelog"));
const HelpCenter = lazy(() => import(/* webpackChunkName: "help-center" */ "../app/(site)/(site)/_components/HelpCenter"));
const DesignSystem = lazy(() => import(/* webpackChunkName: "design-system" */ "../app/(site)/(site)/_components/DesignSystem"));
const StatusPage = lazy(() => import(/* webpackChunkName: "status" */ "../app/(site)/(site)/_components/Status"));
const Security = lazy(() => import(/* webpackChunkName: "security" */ "../app/(site)/(site)/_components/Security"));
const Privacy = lazy(() => import(/* webpackChunkName: "privacy" */ "../app/(site)/(site)/_components/Privacy"));
const Terms = lazy(() => import(/* webpackChunkName: "terms" */ "../app/(site)/(site)/_components/Terms"));
const Contact = lazy(() => import(/* webpackChunkName: "contact" */ "../app/(site)/(site)/_components/Contact"));
const Marketplace = lazy(() =>
  import(/* webpackChunkName: "marketplace", webpackPrefetch: true */ "../app/(site)/(site)/_components/Marketplace")
);
...
export default function App() {
  ...
  const routeLoaders = useMemo<RouteLoaders>(
    () => ({
      "/": () => import("../app/(site)/(site)/_components/Home"),
      "/pricing": () => import("../app/(site)/(site)/_components/Pricing"),
      "/docs": () => import("../app/(site)/(site)/_components/Docs"),
      "/documentation": () => import("../app/(site)/(site)/_components/Docs"),
      "/design-system": () => import("../app/(site)/(site)/_components/DesignSystem"),
      "/api": () => import("../app/(site)/(site)/_components/ApiReference"),
      "/docs/api": () => import("../app/(site)/(site)/_components/ApiReference"),
      "/blog": () => import("../app/(site)/(site)/_components/Blog"),
      "/case-studies": () => import("../app/(site)/(site)/_components/CaseStudies"),
      "/customers": () => import("../app/(site)/(site)/_components/CaseStudies"),
      "/changelog": () => import("../app/(site)/(site)/_components/Changelog"),
      "/updates": () => import("../app/(site)/(site)/_components/Changelog"),
      "/help": () => import("../app/(site)/(site)/_components/HelpCenter"),
      "/support": () => import("../app/(site)/(site)/_components/HelpCenter"),
      "/status": () => import("../app/(site)/(site)/_components/Status"),
      "/security": () => import("../app/(site)/(site)/_components/Security"),
      "/privacy": () => import("../app/(site)/(site)/_components/Privacy"),
      "/terms": () => import("../app/(site)/(site)/_components/Terms"),
      "/contact": () => import("../app/(site)/(site)/_components/Contact"),
      "/marketplace": () => import("../app/(site)/(site)/_components/Marketplace"),
      "/products/marketplace": () => import("../app/(site)/(site)/_components/Marketplace"),
